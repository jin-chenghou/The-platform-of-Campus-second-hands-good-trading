            ...
            <div class="order-page-container">
                ...
                <div class="order-info-container">
                  ...
                  <!-- <div class="order-info-item">支付状态：{{orderInfo.paymentStatus===0?'未支付':'已支付'}}</div>-->
                    <div class="order-info-item" v-if="orderInfo.paymentStatus===0" > 支付状态：未支付</div>
                    <div class="order-info-item" v-else-if="orderInfo.paymentStatus===1">支付状态：已支付</div>
                    <div class="order-info-item" v-else>支付状态：已退款</div>
                ...
                <div class="menu">
                    ...
                    <el-button v-if="userId==orderInfo.userId&&orderInfo.orderStatus===2" type="danger" plain @click="changeOrderStatus2(5,orderInfo)">申请退货</el-button>
                </div>
            </div>
            <app-foot></app-foot>
        </app-body>
...
<script>
    ...
    export default {
        ...
        methods: {
          ...
          changeOrderStatus2(orderStatus, orderInfo) {
            if (orderStatus === 1) {
              console.log('zhifu');
              if(!this.addressInfo.detailAddress){
                this.$message.error('请选择地址！')
