<template>
    <div>
        ...
        <app-body>
            <div v-if="!eidtAddress && !eidtInfo">
                <div class="user-info-container">
                    <div class="user-info-details">
                        ...
                        <div class="user-info-details-text">
                            <div class="user-info-details-text-nickname">{{userInfo.nickname}} 性别：{{userInfo.sex}}</div>
                            <div class="user-info-details-text-time">{{userInfo.signInTime}} 加入平台</div>
                            <div class="user-info-details-text-edit">
                                <el-button type="primary" plain @click="eidtInfo = true">编辑个人信息</el-button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="idle-container">
                    <el-tabs v-model="activeName" @tab-click="handleClick">
                        <el-tab-pane label="我发布的" name="1" v-if='isUser'></el-tab-pane>
                        <el-tab-pane label="我下架的" name="2" v-if='isUser'></el-tab-pane>
                        <el-tab-pane label="我收藏的" name="3"></el-tab-pane>
                        <el-tab-pane label="我卖出的" name="4" v-if='isUser'></el-tab-pane>
             ...
             <div v-if="eidtInfo" class="address-container">
            <el-page-header class="address-container-back" @back="eidtInfo=false"
                            content="修改信息"></el-page-header>
            <div class="address-container-add">
              <div class="address-container-add-title">修改个人信息</div>
                    ...
                    <el-radio-group v-model="userInfo.sex"  :disabled="notUserNicknameEdit" @change="saveUserNickname">
                        <el-radio label="男">男</el-radio>
                        <el-radio label="女">女</el-radio>
                    </el-radio-group>

                    <div class="edit-tip">钱包</div>
                    <el-input disabled v-model="userInfo.wallet" style="width: 200px"></el-input>

                    <el-input  v-model="money" style="width: 460px">
                      <el-button slot="append" type="warning" icon="el-icon-thumb"
                                 @click="chongzhi">充值
                      </el-button>
                    </el-input>

                    <div class="edit-tip">积分</div>
                    <el-input disabled v-model="userInfo.integral"></el-input>

                    <div class="edit-tip">银行账户</div>
                    <el-input
                    ...
                    <div v-if='isUser'>
                      <div class="edit-tip">身份证</div>
                      <el-upload
                          action="http://localhost:8080/file/"
                          :on-success="fileHandleSuccess3"
                          :file-list="imgFileList"
                          accept="image/*"
                      >
                        <el-image
            ...
            <div v-if="eidtAddress" class="address-container">
    ...
    export default {
      ...
      created() {
        ...
        methods: {
            ...
            fileHandleSuccess2(response, file, fileList) {
                console.log("file:", response, file, fileList);
                let imgUrl = response.data;
                this.imgFileList = [];
                this.$api.updateUserPublicInfo({
                    ...
                    console.log(res);
                    this.userInfo.businessLicense = imgUrl;
                })
            },
            fileHandleSuccess3(response, file, fileList) {
              console.log("file:", response, file, fileList);
              let imgUrl = response.data;
              this.imgFileList = [];
              this.$api.updateUserPublicInfo({
